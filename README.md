...
* Similar to React in the way that its a javascript framework but for the backend. It utilizes the server module in Node to accomplish this. Can work with middleware.

- [ ] Describe Middleware?

* MIddleware are essentially functions that access other functions. Allows us to send data, capture and manipulate, then send it back out

- [ ] Describe a Resource?

* A resource would be like a specific endpoint that returns a set of data. in a RESTful API everything is considered a resource.

- [ ] What can the API return to help clients know if a request was successful?

* They can return HTTP response codes which designate certain values such as success or unknown server error
